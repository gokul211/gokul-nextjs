      ...
      <div ref={containerRef} className="relative container mx-auto px-4">
        ...
        <div className="sticky top-0 h-screen flex items-center justify-center z-0">
          <div className="text-center px-2">
            <h1 className="font-akina text-[2.5rem] leading-[1.1] text-purple-900 uppercase max-sm:text-[2rem]">
              BOMBON FANS <br /> CAN’T STOP <br /> TALKING!
            </h1>
          </div>
          ...
          <div className="relative w-full h-screen flex items-center justify-center">
            {reviews.map((r, i) => {
              ...
              return (
                <div
                  key={r.id}
                  className="absolute left-1/2 top-1/2 w-[90%] max-w-sm rounded-2xl bg-purple-50 shadow-2xl flex flex-col items-center gap-4 p-4 transition-transform duration-500 ease-out hover:scale-105 hover:z-50"
                  style={{
                    transform,
                    opacity,
                    zIndex,
                ...
                >
                  ...
                  <div className="w-full text-center">
                    ...
                    <p className="text-[0.9rem] text-gray-800 leading-[1.3] px-1">
                      {r.text}
                    </p>
