...
export default function V41() {
  const testimonials = [
    {
      ...
      animation: 'slide-up', // Changed to slide-up for mobile
    },
    {
      quoteIcon: "https://cdn.prod.website-files.com/68487f7195aeb42041c38e2e/684e72bf66233c7798279e58_Group%2011.svg",
      text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
  ...
  return (
    <section id="testimonial" className="py-8 px-4 bg-gray-100"> {/* Adjusted padding for mobile */}
      <style jsx>{`
      ...
      `}</style>
      <div className="max-w-screen-sm mx-auto"> {/* Max width for mobile */}
        <div className="text-center mb-8"> {/* Adjusted margin for mobile */}
          <div className="text-sm font-semibold text-blue-600 uppercase tracking-wider mb-2">Testimonial</div>
          <h2 className="text-2xl font-extrabold text-gray-900 leading-tight"> {/* Adjusted font size for mobile */}
            Feedback That Speaks Volumes
          </h2>
        </div>
        <div className="grid grid-cols-1 gap-6"> {/* Single column for mobile */}
