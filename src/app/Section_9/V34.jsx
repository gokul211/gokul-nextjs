...
export default function V34() {
  ...
  return (
    <div className="footer-section bg-gradient-to-b from-[#abff594d] to-white text-gray-800">
            ...
            <div className="max-width-large mx-auto text-center">
              ...
              >
                <div className="section-title-block text-center">
                  <h2
                    className="heading-style-h2 text-3xl font-bold text-black mb-2"
                ...
                >
                  <a
                    ...
                    href="/pricing"
                    className="group button is-secondary w-inline-block bg-gradient-to-r from-lime-400 to-cyan-400 text-white font-bold py-2 px-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center text-sm"
                  >
                    <div
                    ...
                    <svg
                      className="w-4 h-4 ml-1 opacity-0 group-hover:opacity-100 transform transition-transform duration-300 group-hover:translate-x-0 -translate-x-4"
      ...
      <hr className="border-gray-300 my-2 max-w-7xl mx-auto px-4" />
          ...
          <div className="container-large">
            <div className="footer-wrapper flex flex-col items-center text-center">
              <div
                ...
                className="footer-left-block w-full mb-6"
                style={{
                  opacity: 1,
              ...
              >
                <a
                  href="/"
                  aria-current="page"
                  className="footer-logo w-inline-block w--current flex items-center justify-center"
                >
                  <img
                    ...
                    className="footer-logo-image h-7 mr-1"
                  />
                  <span className="text-xl font-bold text-black">ssags</span>
                </a>
              ...
              <div
                ...
                className="footer-right-block w-full flex flex-wrap justify-center"
                style={{
                  transform: "translate3d(0px, 0rem, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
                  transformStyle: "preserve-3d",
                  opacity: 1,
              ...
              >
                {Object.entries(footerLinks).map(([title, links]) => (
                  <div key={title} className="footer-menu-box w-1/2 mb-4">
                    <div className="text-sm font-bold text-black mb-2 inline-block border-b-2 border-black pb-1"> {/* Underline applied directly to the title text */}
                      {title}
                    </div>
                    <div className="footer-menu-link-box flex flex-col space-y-1">
                      {links.map((link, idx) => (
                        <a key={idx} href="#" className="footer-link text-gray-700 hover:text-black text-sm">
                          {link}
                        </a>
                      ))}
                    </div>
