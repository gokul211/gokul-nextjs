...
export function V281() {
  ...
  return (
    <section className="h-screen flex flex-col items-center justify-between px-8 py-8 relative bg-[#0a0a0a] text-white overflow-hidden">
      <h2 
        className="text-4xl lg:text-5xl xl:text-6xl font-normal text-center max-w-[90%] mb-4 leading-tight z-10 relative pt-4"
        style={{ animation: 'fadeInDown 1s ease-out' }}
      >
        Create stunning fashion photos <br></br>using AI models
      </h2>
      
      <div className="w-screen flex-1 relative mb-4 overflow-hidden">
        <div 
      ...
      <div 
        className="text-center z-10 relative pb-4"
        style={{ animation: 'fadeInUp 1s ease-out 0.3s backwards' }}
      >
        <div className="text-base lg:text-lg mb-3 max-w-[700px] leading-relaxed opacity-95">
          From briefs to stunning images in seconds: save time, cut costs, and drive success!
        </div>
        <button className="h-[45px] w-[150px] rounded-[20px] text-black bg-white border-none cursor-pointer text-base">
